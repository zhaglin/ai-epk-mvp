...
- **Поля формы**: Единый стиль с иконками и улучшенной типографикой
- **Дизайн PDF**: Профессиональная верстка с градиентными заголовками
- **Адаптивность**: Оптимизировано для всех размеров экранов
- **Темная тема**: Полная поддержка по всему приложению
